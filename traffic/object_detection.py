    ...
    for box in boxes:
        ...
        if label >= 0:
            ...
            if tf:
                ...
                cv2.waitKey(5)
                cv2.imwrite(
                    "C:/Users/DHARANEESH GG/PycharmProjects/Traffic_Recog/Media/Detected_Images/violation_" + str(
                        dcnt) + ".jpg", cimg)
                dcnt = dcnt + 1
...
weights_path = "C:/Users/DHARANEESH GG/PycharmProjects/Traffic_Recog/yolov3.weights"
# set some parameters
net_h, net_w = 416, 416
